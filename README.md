...
# Dependency
    ...
    cuda-profiler-api         12.3.52                       0    nvidia
    cuda-runtime              11.8.0                        0    nvidia
    cycler                    0.12.1                   pypi_0    pypi
    debugpy                   1.8.1                    pypi_0    pypi
    decorator                 5.1.1                    pypi_0    pypi
    defusedxml                0.7.1                    pypi_0    pypi
    dependencies              2.0.1                    pypi_0    pypi
    dpkt                      1.9.8                    pypi_0    pypi
    fastjsonschema            2.19.1                   pypi_0    pypi
    filelock                  3.9.0           py311haa95532_0    defaults
    flowcontainer             7.4                      pypi_0    pypi
    ...
    joblib                    1.2.0           py311haa95532_0    defaults
    ...
    libcurand-dev             10.3.4.52                     0    nvidia
    ...
    mpmath                    1.3.0           py311haa95532_0    defaults
    nbclient                  0.10.0                   pypi_0    pypi
    nbconvert                 7.16.3                   pypi_0    pypi
    nbformat                  5.10.4                   pypi_0    pypi
    nest-asyncio              1.6.0                    pypi_0    pypi
    networkx                  3.1             py311haa95532_0    defaults
    notebook                  7.1.2                    pypi_0    pypi
    notebook-shim             0.2.4                    pypi_0    pypi
    numba                     0.59.1                   pypi_0    pypi
    numpy                     1.26.0          py311hdab7c0b_0    defaults
    numpy-base                1.26.0          py311hd01c5d8_0    defaults
    ...
    scikit-learn              1.2.2           py311hd77b12b_1    defaults
    scipy                     1.13.0rc1                pypi_0    pypi
    ...
    sympy                     1.11.1          py311haa95532_0    defaults
    ...
    typing_extensions         4.7.1           py311haa95532_0    defaults
    tzdata                    2024.1                   pypi_0    pypi
    unfoldnd                  0.2.1                    pypi_0    pypi
